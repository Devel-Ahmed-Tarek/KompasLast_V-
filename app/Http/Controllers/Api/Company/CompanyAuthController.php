    ...
    public function registerPost(Request $request)
    {
        ...
        try {
            ...
            DB::table('company_details')->insert([
                ...
                'founded_year' => $request->foundedYear ?: 'N/A',
                'owner_name'   => $request->ownerName ?: 'N/A',
                ...
                'banc_ip'      => $request->banc_ip ?: 'N/A',
                'banc_count'   => $request->banc_count ?: 'N/A',
                'banc_name'    => $request->banc_name ?: 'N/A',
                'number'       => $request->mobileNumber ?: '0/1',
